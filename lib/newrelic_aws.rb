...
module NewRelicAWS
  ...
  module Base
    class Agent < NewRelic::Plugin::Agent::Base
      ...
      def setup_metrics
        ...
        @components_collection = Components::Collection.new("com.webgeoservices.aws.#{agent_name}", NewRelicAWS::VERSION)
  ...
  module EC2
    class Agent < Base::Agent
      agent_guid "com.webgeoservices.aws.ec2"
  ...
  module EBS
    class Agent < Base::Agent
      agent_guid "com.webgeoservices.aws.ebs"
      agent_version NewRelicAWS::VERSION
  ...
  module ELB
    class Agent < Base::Agent
      agent_guid "com.webgeoservices.aws.elb"
      agent_version NewRelicAWS::VERSION
  ...
  module RDS
    class Agent < Base::Agent
      agent_guid "com.webgeoservices.aws.rds"
      agent_version NewRelicAWS::VERSION
  ...
  module DDB
    class Agent < Base::Agent
      agent_guid "com.webgeoservices.aws.ddb"
      agent_version NewRelicAWS::VERSION
  ...
  module SQS
    class Agent < Base::Agent
      agent_guid "com.webgeoservices.aws.sqs"
      agent_version NewRelicAWS::VERSION
  ...
  module SNS
    class Agent < Base::Agent
      agent_guid "com.webgeoservices.aws.sns"
      agent_version NewRelicAWS::VERSION
  ...
  module EC
    class Agent < Base::Agent
      agent_guid "com.webgeoservices.aws.ec"
      agent_version NewRelicAWS::VERSION
  ...
  module ECR
    class Agent < Base::Agent
      agent_guid "com.webgeoservices.aws.ecr"
      agent_version NewRelicAWS::VERSION
